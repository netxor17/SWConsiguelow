           ...
           <!-- <h1>CONSIGUELOW</h1> -->
            <div>
                ...
                <p><strong>Formato tipo subasta: </strong>Deberás hacer ofertas junto con otros compradores a partir de una cantidad que supere el precio inicial del vendedor,
                    ...
                    Al finalizar el anuncio, el mejor postor adquirirá el artículo y completará la compra </p></br>
            ...
            <div>
                ...
                <p>En CONSIGUELOW se puede tanto realizar compras directas como subastas de productos y todo el mundo puede hacerlo solo con tener una cuenta de correo. Sin embargo, 
                    ...
                    Puedes iniciar sesión con tu nombre de usuario o la dirección de correo electrónico asociada con tu cuenta de CONSIGUELOW.</p></br>
                ...
                valorar transacciones, comentar anuncios,  y elegir a su propia comunidad de compradores y vendedores. </p></br>  
                ...
                también bloquear usuarios, ver e intervenir transacciones, y escribir comentarios y mensajes privados  </p></br>   
            </div>
